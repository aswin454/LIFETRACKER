...
export default function LoginPage() {
  ...
  const { login, googleLogin, error, setError, user } = useAuth();
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-950/40 border border-slate-800 hover:border-slate-700 focus:border-indigo-500 rounded-xl py-3 pl-11 pr-4 text-white placeholder-slate-600 focus:outline-none focus:ring-4 focus:ring-indigo-500/15 transition-all text-sm"
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <a href="#" className="text-xs text-indigo-400 hover:underline hover:text-indigo-300">
                Forgot password?
              </a>
            </div>
            <div className="relative">
          ...
          <button
            ...
            className="w-full relative group overflow-hidden bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 text-white rounded-xl py-3.5 font-semibold text-sm transition-colors shadow-lg shadow-indigo-600/20 flex items-center justify-center gap-2 mt-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loadingState ? (
